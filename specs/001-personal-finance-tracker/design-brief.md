...
### 5.1 Início / Resumo do mês (P1 — US2, US11 sugestão de cartão)
...
### 5.3 Cartão — Detalhe / Faturas (P1 — US1)
...
### 5.5 Nova Compra / Editar Compra (P1 — US2, US4, US9, US10)
...
### 5.6 Importar Fatura via CSV (P2 — US3)
...
### 5.7 Assinaturas — Lista e Total (P2 — US6)
...
### 5.8 Nova Assinatura / Editar Assinatura (P2 — US6)
...
### 5.9 Reservas (Dinheiro Guardado) — Lista (P3 — US7)
...
### 5.10 Reserva — Detalhe / Extrato (P3 — US7)
...
### 5.11 Categorias — Gerenciar (P2 — US9)
...
### 5.12 Estabelecimentos — Gerenciar (P3 — US10)
...
### 5.13 Renda & Entradas Avulsas (P1 — US2)
...
### 5.14 Backup — Exportar/Importar (P1 — US8)
...
- Estrutura de navegação principal (ex.: barra de abas inferior com Início / Cartões / Assinaturas
  / Reservas / Mais) — sugestão de ponto de partida, não uma decisão fechada.
